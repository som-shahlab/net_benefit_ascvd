...
import os
from net_benefit_ascvd.prediction_utils.extraction_utils.featurizer import BigQueryOMOPFeaturizer
...
parser.add_argument("--rs_dataset", type=str, default="")
